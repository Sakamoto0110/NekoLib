# F1-PIPE Candidate Migration

**Document ID:** PIPE-MIGRATION-F1
...
**Subject:** migration from the initial Pipes candidate surface to the accepted F1-PIPE ownership, lifecycle, event, metrics, error, and target contracts
