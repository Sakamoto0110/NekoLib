...
**Subject:** migration from the initial Inspection candidate surface to the accepted passive runtime and experimental action boundary
...
the [Inspection public API review](../audits/public-api-review-2026-08-17.md).
The contracts themselves are owned by the
[Inspection reference](../REFERENCE.md).
