# F1-WDOG-HOST Candidate Migration

**Document ID:** WDGHOST-MIGRATION-F1
...
**Subject:** migration from the initial Watchdog Host candidate package to the accepted direct-deployment, protocol-v1, working-directory, and fatal-evidence contracts
...
[`NekoLib.Watchdog.Host` reference](../REFERENCE.md).
