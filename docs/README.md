...
| [`docs/stable-release-1.1.0.md`](stable-release-1.1.0.md) | reference | current | Current compatible minor, qualifying package provenance, hashes, validation, and public distribution evidence |
