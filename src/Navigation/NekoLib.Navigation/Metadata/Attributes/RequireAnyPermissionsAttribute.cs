...
{
    /// <summary>Requires at least one configured permission before entering the attributed page.</summary>
    public sealed class RequireAnyPermissionsAttribute : GuardAttribute
    {
        private readonly string[] _permissions;

        /// <summary>Initializes the attribute with alternative permission names.</summary>
