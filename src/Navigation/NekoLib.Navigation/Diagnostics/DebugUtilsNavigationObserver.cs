...
{
    /// <summary>
    /// Projects the scalar navigation trace into DebugUtils operations and
    /// pull-based state. Providers only read immutable copies maintained by this
    /// observer; <see cref="IDebugUtils"/> consumers never touch UI objects,
    ...
    public sealed class DebugUtilsNavigationObserver : IDisposable
    {
        ...
        private DebugUtilsNavigationObserver(
            ...
            IDebugUtils debug)
        {
            ...
            return new DebugUtilsNavigationObserver(
                context.Events,
                context,
                debug);
        }
